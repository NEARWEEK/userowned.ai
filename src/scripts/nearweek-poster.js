 ...
 * Posts campaign content to ai_x_crypto Telegram pool
 */
...
class NEARWEEKContentPoster {
  ...
  async postToTelegram(message) {
    if (!this.telegramToken || !message) {
      console.log('⚠️ Missing credentials or message');
      return;
    }
